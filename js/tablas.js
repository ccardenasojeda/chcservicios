jQuery(document).ready(function () {
    ...
    function tablaStock(where){
        ...
        jQuery('#cdrStock').DataTable({
            ...
            "sPaginationType": "full_numbers",
            "ajax": {
                "url": "../controlador/ci_stock.php?opcion=listado&filtro=0",
                "type": "GET"
            },
            "columns": [
                {"data": "nombre"}, //0
            ...
            "columnDefs":
                    [
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                //console.log(row);
                                return '<a id="ver" class="btn-floating red info" title="Ver Información de Stock" onclick="$(this).btnMuestraInfo(' + row.id + ')"> <i class="material-icons" >pageview</i></a>';
